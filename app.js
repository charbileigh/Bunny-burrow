...
const soundNames = { fire: 'Crackling fire', beach: 'Beach ambience', ocean: 'Ocean waves', rain: 'Gentle rain', forest: 'Forest breeze', stream: 'Flowing stream', forest_trees: 'Forest trees', lofi_petal: 'Lo-fi · Petal study', lofi_moon: 'Lo-fi · Moonlit notes', lofi_cocoa: 'Lo-fi · Cocoa break', none: 'Quiet focus' };
